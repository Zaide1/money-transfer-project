...
export default function Home() {
  return (
    <div className={styles.container}>
      <Head>
        <title>Srai Shazada Money Transferz - Secure and Fast Online Transactions</title>
